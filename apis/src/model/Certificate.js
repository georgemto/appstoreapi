...
class Certificate {
    ...
    constructor(type, id) { 
        ...
        Certificate.initialize(this, type, id);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = CertificateRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['relationships']) { // data not null
          CertificateRelationships.validateJSON(data['relationships']);
        }
...
Certificate.RequiredProperties = ["type", "id"];
 ...
 */
Certificate.prototype['relationships'] = undefined;
