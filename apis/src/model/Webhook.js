...
class Webhook {
     ...
     * @param type {module:model/Webhook.TypeEnum} 
     * @param id {String} 
     */
    constructor(type, id) { 
        
        Webhook.initialize(this, type, id);
    }
...
Webhook.RequiredProperties = ["type", "id"];

/**
 * @member {module:model/Webhook.TypeEnum} type
 */
 ...
 */
Webhook.prototype['links'] = undefined;
