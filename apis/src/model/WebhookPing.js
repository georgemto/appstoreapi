...
class WebhookPing {
     ...
     * @param type {module:model/WebhookPing.TypeEnum} 
     * @param id {String} 
     */
    constructor(type, id) { 
        
        WebhookPing.initialize(this, type, id);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of WebhookPing.RequiredProperties) {
...
WebhookPing.RequiredProperties = ["type", "id"];

/**
 * @member {module:model/WebhookPing.TypeEnum} type
 */
WebhookPing.prototype['type'] = undefined;

/**
 * @member {String} id
 */
WebhookPing.prototype['id'] = undefined;

/**
 * @member {module:model/ResourceLinks} links
 */
WebhookPing.prototype['links'] = undefined;
