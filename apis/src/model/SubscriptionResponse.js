...
class SubscriptionResponse {
    ...
    constructor(data, links) { 
        ...
        SubscriptionResponse.initialize(this, data, links);
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          Subscription.validateJSON(data['data']);
        }
...
SubscriptionResponse.RequiredProperties = ["data", "links"];
 ...
 */
SubscriptionResponse.prototype['included'] = undefined;

/**
 * @member {module:model/DocumentLinks} links
 */
SubscriptionResponse.prototype['links'] = undefined;
