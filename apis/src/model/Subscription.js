...
class Subscription {
     ...
     * @param type {module:model/Subscription.TypeEnum} 
     * @param id {String} 
     */
    constructor(type, id) { 
        
        Subscription.initialize(this, type, id);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = SubscriptionAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = SubscriptionRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          SubscriptionAttributes.validateJSON(data['attributes']);
        }
        // validate the optional field `relationships`
        if (data['relationships']) { // data not null
          SubscriptionRelationships.validateJSON(data['relationships']);
        }
...
Subscription.RequiredProperties = ["type", "id"];

/**
 * @member {module:model/Subscription.TypeEnum} type
 */
 ...
 */
Subscription.prototype['attributes'] = undefined;

/**
 * @member {module:model/SubscriptionRelationships} relationships
 */
Subscription.prototype['relationships'] = undefined;

/**
 * @member {module:model/ResourceLinks} links
 */
Subscription.prototype['links'] = undefined;
