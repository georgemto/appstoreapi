...
class CertificateCreateRequestDataAttributes {
     ...
     */
    constructor(csrContent, certificateType) { 
        
        CertificateCreateRequestDataAttributes.initialize(this, csrContent, certificateType);
    }
     ...
     */
    static initialize(obj, csrContent, certificateType) { 
...
CertificateCreateRequestDataAttributes.RequiredProperties = ["csrContent", "certificateType"];
