...
class ErrorResponseErrorsInner {
    ...
    constructor(status, code, title, detail) { 
        ...
        ErrorResponseErrorsInner.initialize(this, status, code, title, detail);
    }
     ...
     */
    static initialize(obj, status, code, title, detail) { 
        obj['status'] = status;
        obj['code'] = code;
        obj['title'] = title;
        obj['detail'] = detail;
...
ErrorResponseErrorsInner.RequiredProperties = ["status", "code", "title", "detail"];
 ...
 */
ErrorResponseErrorsInner.prototype['links'] = undefined;

/**
 * @member {Object.<String, Object>} meta
 */
ErrorResponseErrorsInner.prototype['meta'] = undefined;
