...
export default class PreReleaseVersionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the preReleaseVersionsAppGetToOneRelationship operation.
     * @callback module:api/PreReleaseVersionsApi~preReleaseVersionsAppGetToOneRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PrereleaseVersionAppLinkageResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * @param {String} id the id of the requested resource
     * @param {module:api/PreReleaseVersionsApi~preReleaseVersionsAppGetToOneRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PrereleaseVersionAppLinkageResponse}
     */
    preReleaseVersionsAppGetToOneRelationship(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling preReleaseVersionsAppGetToOneRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PrereleaseVersionAppLinkageResponse;
      return this.apiClient.callApi(
        '/v1/preReleaseVersions/{id}/relationships/app', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the preReleaseVersionsBuildsGetToManyRelationship operation.
     * @callback module:api/PreReleaseVersionsApi~preReleaseVersionsBuildsGetToManyRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PrereleaseVersionBuildsLinkagesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [limit] maximum resources per page
     * @param {module:api/PreReleaseVersionsApi~preReleaseVersionsBuildsGetToManyRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PrereleaseVersionBuildsLinkagesResponse}
     */
    preReleaseVersionsBuildsGetToManyRelationship(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling preReleaseVersionsBuildsGetToManyRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PrereleaseVersionBuildsLinkagesResponse;
      return this.apiClient.callApi(
        '/v1/preReleaseVersions/{id}/relationships/builds', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/String>} [filterBuildsBuildAudienceType] filter by attribute 'builds.buildAudienceType'
     ...
     * @param {Array.<String>} [filterBuildsVersion] filter by attribute 'builds.version'
    ...
    preReleaseVersionsGetCollection(opts, callback) {
      ...
      let queryParams = {
        'filter[builds.buildAudienceType]': this.apiClient.buildCollectionParam(opts['filterBuildsBuildAudienceType'], 'csv'),
        ...
        'filter[builds.version]': this.apiClient.buildCollectionParam(opts['filterBuildsVersion'], 'csv'),
