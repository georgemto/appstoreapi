...
export default class BundleIdsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the bundleIdsAppGetToOneRelationship operation.
     * @callback module:api/BundleIdsApi~bundleIdsAppGetToOneRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BundleIdAppLinkageResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * @param {String} id the id of the requested resource
     * @param {module:api/BundleIdsApi~bundleIdsAppGetToOneRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BundleIdAppLinkageResponse}
     */
    bundleIdsAppGetToOneRelationship(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling bundleIdsAppGetToOneRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = BundleIdAppLinkageResponse;
      return this.apiClient.callApi(
        '/v1/bundleIds/{id}/relationships/app', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/BundleIdCapabilitiesWithoutIncludesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/BundleIdCapabilitiesWithoutIncludesResponse}
     */
    bundleIdsBundleIdCapabilitiesGetToManyRelated(id, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = BundleIdCapabilitiesWithoutIncludesResponse;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the bundleIdsBundleIdCapabilitiesGetToManyRelationship operation.
     * @callback module:api/BundleIdsApi~bundleIdsBundleIdCapabilitiesGetToManyRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BundleIdBundleIdCapabilitiesLinkagesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [limit] maximum resources per page
     * @param {module:api/BundleIdsApi~bundleIdsBundleIdCapabilitiesGetToManyRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BundleIdBundleIdCapabilitiesLinkagesResponse}
     */
    bundleIdsBundleIdCapabilitiesGetToManyRelationship(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling bundleIdsBundleIdCapabilitiesGetToManyRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = BundleIdBundleIdCapabilitiesLinkagesResponse;
      return this.apiClient.callApi(
        '/v1/bundleIds/{id}/relationships/bundleIdCapabilities', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ProfilesWithoutIncludesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ProfilesWithoutIncludesResponse}
     */
    bundleIdsProfilesGetToManyRelated(id, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ProfilesWithoutIncludesResponse;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the bundleIdsProfilesGetToManyRelationship operation.
     * @callback module:api/BundleIdsApi~bundleIdsProfilesGetToManyRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BundleIdProfilesLinkagesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [limit] maximum resources per page
     * @param {module:api/BundleIdsApi~bundleIdsProfilesGetToManyRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BundleIdProfilesLinkagesResponse}
     */
    bundleIdsProfilesGetToManyRelationship(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling bundleIdsProfilesGetToManyRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = BundleIdProfilesLinkagesResponse;
      return this.apiClient.callApi(
        '/v1/bundleIds/{id}/relationships/profiles', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
