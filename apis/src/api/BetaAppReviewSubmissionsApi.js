...
export default class BetaAppReviewSubmissionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the betaAppReviewSubmissionsBuildGetToOneRelationship operation.
     * @callback module:api/BetaAppReviewSubmissionsApi~betaAppReviewSubmissionsBuildGetToOneRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BetaAppReviewSubmissionBuildLinkageResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * @param {String} id the id of the requested resource
     * @param {module:api/BetaAppReviewSubmissionsApi~betaAppReviewSubmissionsBuildGetToOneRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BetaAppReviewSubmissionBuildLinkageResponse}
     */
    betaAppReviewSubmissionsBuildGetToOneRelationship(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling betaAppReviewSubmissionsBuildGetToOneRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = BetaAppReviewSubmissionBuildLinkageResponse;
      return this.apiClient.callApi(
        '/v1/betaAppReviewSubmissions/{id}/relationships/build', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
