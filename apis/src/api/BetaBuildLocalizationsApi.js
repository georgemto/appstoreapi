...
export default class BetaBuildLocalizationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the betaBuildLocalizationsBuildGetToOneRelationship operation.
     * @callback module:api/BetaBuildLocalizationsApi~betaBuildLocalizationsBuildGetToOneRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BetaBuildLocalizationBuildLinkageResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * @param {String} id the id of the requested resource
     * @param {module:api/BetaBuildLocalizationsApi~betaBuildLocalizationsBuildGetToOneRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BetaBuildLocalizationBuildLinkageResponse}
     */
    betaBuildLocalizationsBuildGetToOneRelationship(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling betaBuildLocalizationsBuildGetToOneRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = BetaBuildLocalizationBuildLinkageResponse;
      return this.apiClient.callApi(
        '/v1/betaBuildLocalizations/{id}/relationships/build', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
