...
export default class SalesReportsApi {
    ...
    */
     ...
     */
    salesReportsGetCollection(filterVendorNumber, filterReportType, filterReportSubType, filterFrequency, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json', 'application/a-gzip'];
      let returnType = File;
