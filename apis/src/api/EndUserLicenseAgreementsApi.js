...
export default class EndUserLicenseAgreementsApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/TerritoriesWithoutIncludesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/TerritoriesWithoutIncludesResponse}
     */
    endUserLicenseAgreementsTerritoriesGetToManyRelated(id, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TerritoriesWithoutIncludesResponse;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the endUserLicenseAgreementsTerritoriesGetToManyRelationship operation.
     * @callback module:api/EndUserLicenseAgreementsApi~endUserLicenseAgreementsTerritoriesGetToManyRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EndUserLicenseAgreementTerritoriesLinkagesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [limit] maximum resources per page
     * @param {module:api/EndUserLicenseAgreementsApi~endUserLicenseAgreementsTerritoriesGetToManyRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EndUserLicenseAgreementTerritoriesLinkagesResponse}
     */
    endUserLicenseAgreementsTerritoriesGetToManyRelationship(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling endUserLicenseAgreementsTerritoriesGetToManyRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = EndUserLicenseAgreementTerritoriesLinkagesResponse;
      return this.apiClient.callApi(
        '/v1/endUserLicenseAgreements/{id}/relationships/territories', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
