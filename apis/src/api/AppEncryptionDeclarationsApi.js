...
export default class AppEncryptionDeclarationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelated operation.
     * @callback module:api/AppEncryptionDeclarationsApi~appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelatedCallback
     ...
     * @param {module:api/AppEncryptionDeclarationsApi~appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelatedCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AppEncryptionDeclarationDocumentResponse}
     */
    appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelated(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelated");
      }
      ...
      return this.apiClient.callApi(
        '/v1/appEncryptionDeclarations/{id}/appEncryptionDeclarationDocument', 'GET',
    ...
    /**
     * Callback function to receive the result of the appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelationship operation.
     * @callback module:api/AppEncryptionDeclarationsApi~appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AppEncryptionDeclarationAppEncryptionDeclarationDocumentLinkageResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * @param {String} id the id of the requested resource
     * @param {module:api/AppEncryptionDeclarationsApi~appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AppEncryptionDeclarationAppEncryptionDeclarationDocumentLinkageResponse}
     */
    appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelationship(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AppEncryptionDeclarationAppEncryptionDeclarationDocumentLinkageResponse;
      return this.apiClient.callApi(
        '/v1/appEncryptionDeclarations/{id}/relationships/appEncryptionDeclarationDocument', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the appEncryptionDeclarationsAppGetToOneRelationship operation.
     * @callback module:api/AppEncryptionDeclarationsApi~appEncryptionDeclarationsAppGetToOneRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AppEncryptionDeclarationAppLinkageResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * @param {String} id the id of the requested resource
     * @param {module:api/AppEncryptionDeclarationsApi~appEncryptionDeclarationsAppGetToOneRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AppEncryptionDeclarationAppLinkageResponse}
     */
    appEncryptionDeclarationsAppGetToOneRelationship(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling appEncryptionDeclarationsAppGetToOneRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AppEncryptionDeclarationAppLinkageResponse;
      return this.apiClient.callApi(
        '/v1/appEncryptionDeclarations/{id}/relationships/app', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the appEncryptionDeclarationsCreateInstance operation.
     * @callback module:api/AppEncryptionDeclarationsApi~appEncryptionDeclarationsCreateInstanceCallback
     * @param {String} error Error message, if any.
    ...
    /**
     * @param {module:model/AppEncryptionDeclarationCreateRequest} appEncryptionDeclarationCreateRequest AppEncryptionDeclaration representation
     * @param {module:api/AppEncryptionDeclarationsApi~appEncryptionDeclarationsCreateInstanceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AppEncryptionDeclarationResponse}
     */
    appEncryptionDeclarationsCreateInstance(appEncryptionDeclarationCreateRequest, callback) {
      let postBody = appEncryptionDeclarationCreateRequest;
      // verify the required parameter 'appEncryptionDeclarationCreateRequest' is set
      if (appEncryptionDeclarationCreateRequest === undefined || appEncryptionDeclarationCreateRequest === null) {
        throw new Error("Missing the required parameter 'appEncryptionDeclarationCreateRequest' when calling appEncryptionDeclarationsCreateInstance");
      }
      ...
      return this.apiClient.callApi(
        '/v1/appEncryptionDeclarations', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
