...
export default class AppStoreReviewDetailsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the appStoreReviewDetailsAppStoreReviewAttachmentsGetToManyRelationship operation.
     * @callback module:api/AppStoreReviewDetailsApi~appStoreReviewDetailsAppStoreReviewAttachmentsGetToManyRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AppStoreReviewDetailAppStoreReviewAttachmentsLinkagesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [limit] maximum resources per page
     * @param {module:api/AppStoreReviewDetailsApi~appStoreReviewDetailsAppStoreReviewAttachmentsGetToManyRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AppStoreReviewDetailAppStoreReviewAttachmentsLinkagesResponse}
     */
    appStoreReviewDetailsAppStoreReviewAttachmentsGetToManyRelationship(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling appStoreReviewDetailsAppStoreReviewAttachmentsGetToManyRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AppStoreReviewDetailAppStoreReviewAttachmentsLinkagesResponse;
      return this.apiClient.callApi(
        '/v1/appStoreReviewDetails/{id}/relationships/appStoreReviewAttachments', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
