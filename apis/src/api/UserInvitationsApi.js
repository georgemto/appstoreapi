...
export default class UserInvitationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the userInvitationsVisibleAppsGetToManyRelationship operation.
     * @callback module:api/UserInvitationsApi~userInvitationsVisibleAppsGetToManyRelationshipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UserInvitationVisibleAppsLinkagesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [limit] maximum resources per page
     * @param {module:api/UserInvitationsApi~userInvitationsVisibleAppsGetToManyRelationshipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UserInvitationVisibleAppsLinkagesResponse}
     */
    userInvitationsVisibleAppsGetToManyRelationship(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling userInvitationsVisibleAppsGetToManyRelationship");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = UserInvitationVisibleAppsLinkagesResponse;
      return this.apiClient.callApi(
        '/v1/userInvitations/{id}/relationships/visibleApps', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
