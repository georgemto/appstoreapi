...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.SubscriptionsResponse();
  });
  ...
  describe('SubscriptionsResponse', function() {
    it('should create an instance of SubscriptionsResponse', function() {
      ...
      //var instance = new AppStoreConnectApi.SubscriptionsResponse();
      //expect(instance).to.be.a(AppStoreConnectApi.SubscriptionsResponse);
    });
