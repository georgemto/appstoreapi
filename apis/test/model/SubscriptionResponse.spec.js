...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.SubscriptionResponse();
  });
  ...
  describe('SubscriptionResponse', function() {
    it('should create an instance of SubscriptionResponse', function() {
      ...
      //var instance = new AppStoreConnectApi.SubscriptionResponse();
      //expect(instance).to.be.a(AppStoreConnectApi.SubscriptionResponse);
    });
