...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.NominationUpdateRequestDataAttributes();
  });
  ...
  describe('NominationUpdateRequestDataAttributes', function() {
    it('should create an instance of NominationUpdateRequestDataAttributes', function() {
      // uncomment below and update the code to test NominationUpdateRequestDataAttributes
      //var instance = new AppStoreConnectApi.NominationUpdateRequestDataAttributes();
      //expect(instance).to.be.a(AppStoreConnectApi.NominationUpdateRequestDataAttributes);
    });
