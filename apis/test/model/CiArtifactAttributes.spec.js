...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.CiArtifactAttributes();
  });
  ...
  describe('CiArtifactAttributes', function() {
    it('should create an instance of CiArtifactAttributes', function() {
      // uncomment below and update the code to test CiArtifactAttributes
      //var instance = new AppStoreConnectApi.CiArtifactAttributes();
      //expect(instance).to.be.a(AppStoreConnectApi.CiArtifactAttributes);
    });
