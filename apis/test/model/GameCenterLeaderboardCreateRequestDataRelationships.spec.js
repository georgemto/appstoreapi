...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.GameCenterLeaderboardCreateRequestDataRelationships();
  });
  ...
  describe('GameCenterLeaderboardCreateRequestDataRelationships', function() {
    it('should create an instance of GameCenterLeaderboardCreateRequestDataRelationships', function() {
      // uncomment below and update the code to test GameCenterLeaderboardCreateRequestDataRelationships
      //var instance = new AppStoreConnectApi.GameCenterLeaderboardCreateRequestDataRelationships();
      //expect(instance).to.be.a(AppStoreConnectApi.GameCenterLeaderboardCreateRequestDataRelationships);
    });
