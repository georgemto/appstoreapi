...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.Checksums();
  });
  ...
  describe('Checksums', function() {
    it('should create an instance of Checksums', function() {
      // uncomment below and update the code to test Checksums
      //var instance = new AppStoreConnectApi.Checksums();
      //expect(instance).to.be.a(AppStoreConnectApi.Checksums);
    });
