...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.TerritoryAvailabilityUpdateRequestDataAttributes();
  });
  ...
  describe('TerritoryAvailabilityUpdateRequestDataAttributes', function() {
    it('should create an instance of TerritoryAvailabilityUpdateRequestDataAttributes', function() {
      // uncomment below and update the code to test TerritoryAvailabilityUpdateRequestDataAttributes
      //var instance = new AppStoreConnectApi.TerritoryAvailabilityUpdateRequestDataAttributes();
      //expect(instance).to.be.a(AppStoreConnectApi.TerritoryAvailabilityUpdateRequestDataAttributes);
    });
