...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.BuildBundle();
  });
  ...
  describe('BuildBundle', function() {
    it('should create an instance of BuildBundle', function() {
      // uncomment below and update the code to test BuildBundle
      //var instance = new AppStoreConnectApi.BuildBundle();
      //expect(instance).to.be.a(AppStoreConnectApi.BuildBundle);
    });
