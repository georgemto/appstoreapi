...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.MerchantId();
  });
  ...
  describe('MerchantId', function() {
    it('should create an instance of MerchantId', function() {
      // uncomment below and update the code to test MerchantId
      //var instance = new AppStoreConnectApi.MerchantId();
      //expect(instance).to.be.a(AppStoreConnectApi.MerchantId);
    });
