...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.ActorResponse();
  });
  ...
  describe('ActorResponse', function() {
    it('should create an instance of ActorResponse', function() {
      ...
      //var instance = new AppStoreConnectApi.ActorResponse();
      //expect(instance).to.be.a(AppStoreConnectApi.ActorResponse);
    });
