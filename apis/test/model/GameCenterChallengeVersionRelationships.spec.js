...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.GameCenterChallengeVersionRelationships();
  });
  ...
  describe('GameCenterChallengeVersionRelationships', function() {
    it('should create an instance of GameCenterChallengeVersionRelationships', function() {
      // uncomment below and update the code to test GameCenterChallengeVersionRelationships
      //var instance = new AppStoreConnectApi.GameCenterChallengeVersionRelationships();
      //expect(instance).to.be.a(AppStoreConnectApi.GameCenterChallengeVersionRelationships);
    });
