...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.ReviewSubmissionUpdateRequestDataAttributes();
  });
  ...
  describe('ReviewSubmissionUpdateRequestDataAttributes', function() {
    it('should create an instance of ReviewSubmissionUpdateRequestDataAttributes', function() {
      // uncomment below and update the code to test ReviewSubmissionUpdateRequestDataAttributes
      //var instance = new AppStoreConnectApi.ReviewSubmissionUpdateRequestDataAttributes();
      //expect(instance).to.be.a(AppStoreConnectApi.ReviewSubmissionUpdateRequestDataAttributes);
    });
