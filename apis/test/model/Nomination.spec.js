...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.Nomination();
  });
  ...
  describe('Nomination', function() {
    it('should create an instance of Nomination', function() {
      // uncomment below and update the code to test Nomination
      //var instance = new AppStoreConnectApi.Nomination();
      //expect(instance).to.be.a(AppStoreConnectApi.Nomination);
    });
