...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.AccessibilityDeclarationCreateRequestDataAttributes();
  });
  ...
  describe('AccessibilityDeclarationCreateRequestDataAttributes', function() {
    it('should create an instance of AccessibilityDeclarationCreateRequestDataAttributes', function() {
      // uncomment below and update the code to test AccessibilityDeclarationCreateRequestDataAttributes
      //var instance = new AppStoreConnectApi.AccessibilityDeclarationCreateRequestDataAttributes();
      //expect(instance).to.be.a(AppStoreConnectApi.AccessibilityDeclarationCreateRequestDataAttributes);
    });
