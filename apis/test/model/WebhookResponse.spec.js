...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.WebhookResponse();
  });
  ...
  describe('WebhookResponse', function() {
    it('should create an instance of WebhookResponse', function() {
      ...
      //var instance = new AppStoreConnectApi.WebhookResponse();
      //expect(instance).to.be.a(AppStoreConnectApi.WebhookResponse);
    });
