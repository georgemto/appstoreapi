...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.MerchantIdCreateRequest();
  });
  ...
  describe('MerchantIdCreateRequest', function() {
    it('should create an instance of MerchantIdCreateRequest', function() {
      ...
      //var instance = new AppStoreConnectApi.MerchantIdCreateRequest();
      //expect(instance).to.be.a(AppStoreConnectApi.MerchantIdCreateRequest);
    });
