...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.GameCenterChallengeCreateRequestDataRelationships();
  });
  ...
  describe('GameCenterChallengeCreateRequestDataRelationships', function() {
    it('should create an instance of GameCenterChallengeCreateRequestDataRelationships', function() {
      // uncomment below and update the code to test GameCenterChallengeCreateRequestDataRelationships
      //var instance = new AppStoreConnectApi.GameCenterChallengeCreateRequestDataRelationships();
      //expect(instance).to.be.a(AppStoreConnectApi.GameCenterChallengeCreateRequestDataRelationships);
    });
