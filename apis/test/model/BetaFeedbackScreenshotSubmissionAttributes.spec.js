...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.BetaFeedbackScreenshotSubmissionAttributes();
  });
  ...
  describe('BetaFeedbackScreenshotSubmissionAttributes', function() {
    it('should create an instance of BetaFeedbackScreenshotSubmissionAttributes', function() {
      // uncomment below and update the code to test BetaFeedbackScreenshotSubmissionAttributes
      //var instance = new AppStoreConnectApi.BetaFeedbackScreenshotSubmissionAttributes();
      //expect(instance).to.be.a(AppStoreConnectApi.BetaFeedbackScreenshotSubmissionAttributes);
    });
