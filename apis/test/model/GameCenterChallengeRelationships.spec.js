...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.GameCenterChallengeRelationships();
  });
  ...
  describe('GameCenterChallengeRelationships', function() {
    it('should create an instance of GameCenterChallengeRelationships', function() {
      // uncomment below and update the code to test GameCenterChallengeRelationships
      //var instance = new AppStoreConnectApi.GameCenterChallengeRelationships();
      //expect(instance).to.be.a(AppStoreConnectApi.GameCenterChallengeRelationships);
    });
