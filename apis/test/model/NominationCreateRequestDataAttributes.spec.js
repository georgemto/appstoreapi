...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.NominationCreateRequestDataAttributes();
  });
  ...
  describe('NominationCreateRequestDataAttributes', function() {
    it('should create an instance of NominationCreateRequestDataAttributes', function() {
      // uncomment below and update the code to test NominationCreateRequestDataAttributes
      //var instance = new AppStoreConnectApi.NominationCreateRequestDataAttributes();
      //expect(instance).to.be.a(AppStoreConnectApi.NominationCreateRequestDataAttributes);
    });
